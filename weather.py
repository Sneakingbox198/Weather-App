...
def getWeather():
    try:
        ...
        #weather part
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=8abc2f7fb84d6956d0c6b3740ea396e4"
...
# I guess this is the search bar?
Search_image=PhotoImage(file="search.png")
myimage=Label(image=Search_image)
myimage.place(x=20,y=20)

textfield=tk.Entry(root, justify="center", width=17,font=("poppins",25,"bold"),bg="#404040",bd=0,fg="white")
...
hum_label=Label(root,text="HUMIDITY",font=("Helvetica",15,'bold'),fg='white',bg="#1ab5ef")
hum_label.place(x=250,y=400)

desc_label=Label(root,text="DESCRIPTION",font=("Helvetica",15,'bold'),fg='white',bg="#1ab5ef")
desc_label.place(x=430,y=400)
